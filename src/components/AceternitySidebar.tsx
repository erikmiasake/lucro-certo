...
import { LayoutDashboard, ArrowLeftRight, Wallet, TrendingUp, Settings, Menu, X, Activity, Sparkles } from "lucide-react";
...
const getLinks = (isPersonal: boolean, glossary: ReturnType<typeof getModeCopyFromType>['glossary']): SidebarLink[] => {
  const links: SidebarLink[] = [
    ...
    { label: "Integração de IA", href: "/connect", icon: <Sparkles className="h-5 w-5 shrink-0" /> },
